...
const teamMembers = [
  ...
  { name: "Wesley Oliveira", role: "CEO & Dev Back-end", image: "https://i.imgur.com/zy5dZ3L.jpeg" },
    ...
    <section id="time" className="py-20 md:py-32 relative overflow-hidden">
        <div className="relative z-10">
            <div className="container mx-auto px-6 text-center">
             ...
             <ul 
                ref={carouselRef}
                className="flex items-start overflow-x-auto hide-scrollbar space-x-8 px-4 [mask-image:_linear_gradient(to_right,transparent_0,_black_128px,_black_calc(100%-128px),transparent_100%)]"
                style={{ cursor: 'grab' }}
